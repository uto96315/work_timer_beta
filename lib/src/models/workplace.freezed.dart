...
mixin _$Workplace {
 ...
 String get id; String get name;/// Base hourly wage in yen.
 ...
 String get endTime; int get breakMinutes;/// Overtime premium, e.g. 25 means 1.25x hourly wage.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,hourlyWage,startTime,endTime,breakMinutes,overtimeRatePercent,const DeepCollectionEquality().hash(holidayWeekdays),createdAt,updatedAt);

@override
String toString() {
  return 'Workplace(id: $id, name: $name, hourlyWage: $hourlyWage, startTime: $startTime, endTime: $endTime, breakMinutes: $breakMinutes, overtimeRatePercent: $overtimeRatePercent, holidayWeekdays: $holidayWeekdays, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, int hourlyWage, String startTime, String endTime, int breakMinutes, int overtimeRatePercent, List<int> holidayWeekdays,@TimestampConverter() DateTime createdAt,@NullableTimestampConverter() DateTime? updatedAt
});
...
/// Create a copy of Workplace
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? hourlyWage = null,Object? startTime = null,Object? endTime = null,Object? breakMinutes = null,Object? overtimeRatePercent = null,Object? holidayWeekdays = null,Object? createdAt = null,Object? updatedAt = freezed,}) {
...
as int,overtimeRatePercent: null == overtimeRatePercent ? _self.overtimeRatePercent : overtimeRatePercent // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  int hourlyWage,  String startTime,  String endTime,  int breakMinutes,  int overtimeRatePercent,  List<int> holidayWeekdays, @TimestampConverter()  DateTime createdAt, @NullableTimestampConverter()  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Workplace() when $default != null:
return $default(_that.id,_that.name,_that.hourlyWage,_that.startTime,_that.endTime,_that.breakMinutes,_that.overtimeRatePercent,_that.holidayWeekdays,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  int hourlyWage,  String startTime,  String endTime,  int breakMinutes,  int overtimeRatePercent,  List<int> holidayWeekdays, @TimestampConverter()  DateTime createdAt, @NullableTimestampConverter()  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Workplace():
return $default(_that.id,_that.name,_that.hourlyWage,_that.startTime,_that.endTime,_that.breakMinutes,_that.overtimeRatePercent,_that.holidayWeekdays,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  int hourlyWage,  String startTime,  String endTime,  int breakMinutes,  int overtimeRatePercent,  List<int> holidayWeekdays, @TimestampConverter()  DateTime createdAt, @NullableTimestampConverter()  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Workplace() when $default != null:
return $default(_that.id,_that.name,_that.hourlyWage,_that.startTime,_that.endTime,_that.breakMinutes,_that.overtimeRatePercent,_that.holidayWeekdays,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Workplace implements Workplace {
  const _Workplace({required this.id, required this.name, required this.hourlyWage, required this.startTime, required this.endTime, required this.breakMinutes, this.overtimeRatePercent = 25, final  List<int> holidayWeekdays = const [], @TimestampConverter() required this.createdAt, @NullableTimestampConverter() this.updatedAt}): _holidayWeekdays = holidayWeekdays;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,hourlyWage,startTime,endTime,breakMinutes,overtimeRatePercent,const DeepCollectionEquality().hash(_holidayWeekdays),createdAt,updatedAt);
...
/// Create a copy of Workplace
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? hourlyWage = null,Object? startTime = null,Object? endTime = null,Object? breakMinutes = null,Object? overtimeRatePercent = null,Object? holidayWeekdays = null,Object? createdAt = null,Object? updatedAt = freezed,}) {
